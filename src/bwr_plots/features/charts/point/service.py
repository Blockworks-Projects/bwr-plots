...
@register_chart(
    ChartMetadata(
        name="point",
        display_name="Point",
        description="Raw x/y point chart with optional grouping, labels, sizing, and trendlines.",
        examples=("dot plot", "bubble chart", "grouped scatter"),
    ),
    PointSpec,
)
def render_point(
    ...
    fig = context.plotter.point_plot(
        ...
        uniform_color=spec.uniform_color,
        show_trendline=spec.show_trendline,
